...
class TopicConsumeCommand extends ContainerAwareCommand {
	...
	protected function configure() {
		$this
			->setName('bruery:kafka:consumer')
            ->setDescription('CLI for consuming kafka messages.')
    ...
    protected function execute(InputInterface $input, OutputInterface $output) {
		...
		$topicConsumer = $this->getContainer()->get('bruery.kafka.manager')->getConsumer($consumer);
		if (!$topicConsumer) {
